      ...
      <div className="max-w-[1280px] mx-auto px-gutter space-y-24">
        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#00d26a] text-sm font-bold uppercase tracking-wider">
            🏷️ Tarifs Clairs et Transparents
          </div>
          ...
          <p className="text-gray-400 text-lg">
            Pas de frais cachés. Nos tarifs sont calculés au mètre cube (m³) réel ou via des forfaits simplifiés selon la taille de votre logement.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-3xl lg:text-4xl font-black font-h2">Forfaits de débarras par logement</h2>
            <p className="text-gray-400">Nos formules standards basées sur la surface habitable (inclut déplacement, tri et recyclage).</p>
          </div>
            ...
            {[
              {
                ...
                volume: "Jusqu'à 8 m³",
                price: "390 €",
                features: ["1 à 2 intervenants", "Déplacement inclus", "Tri sélectif & Recyclage", "Nettoyage balayé rapide", "Donations associations"]
              },
              {
                ...
                volume: "Jusqu'à 20 m³",
                price: "850 €",
                features: ["2 à 3 intervenants", "1 camionnette de 20m³", "Gestion des objets lourds", "Nettoyage balayé complet", "Donations associations", "Garantie protection parties communes"],
                popular: true
              },
              {
                ...
                volume: "Jusqu'à 45 m³",
                price: "1 790 €",
                features: ["3 à 4 intervenants", "2 camions ou rotations", "Vidage grenier & garage", "Nettoyage balayé complet", "Dons & Recyclage de métaux", "Assurance sinistre incluse"]
              }
            ].map((pack, idx) => (
              <div 
                key={idx}
        ...
        <div className="space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-3xl lg:text-4xl font-black font-h2">Comparatif des niveaux de service</h2>
            <p className="text-gray-400">Comparez nos formules d'intervention pour trouver celle qui correspond à votre projet.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse text-sm">
              ...
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  { name: "Destruction d'archives confidentielles certifiée", simple: false, simple: false, clean: "Option", premium: true }
                ].map((row, idx) => (
